...
_lr_productions = [
  ...
  ('PROGRAMA -> DECLARACOES BLOCO','PROGRAMA',2,'p_programa','sintatic.py',16),
  ('BLOCO -> BEGIN COMANDO LISTA_COM END','BLOCO',4,'p_bloco','sintatic.py',20),
  ('DECLARACOES -> DEF_CONST DEF_TIPOS DEF_VAR DEF_ROTINA','DECLARACOES',4,'p_declaracoes','sintatic.py',24),
  ('DEF_CONST -> CONSTANTE DEF_CONST','DEF_CONST',2,'p_def_const','sintatic.py',28),
  ('DEF_CONST -> <empty>','DEF_CONST',0,'p_def_const','sintatic.py',29),
  ('DEF_TIPOS -> TIPO DEF_TIPOS','DEF_TIPOS',2,'p_def_tipos','sintatic.py',37),
  ('DEF_TIPOS -> <empty>','DEF_TIPOS',0,'p_def_tipos','sintatic.py',38),
  ('DEF_VAR -> VARIAVEL DEF_VAR','DEF_VAR',2,'p_def_var','sintatic.py',46),
  ('DEF_VAR -> <empty>','DEF_VAR',0,'p_def_var','sintatic.py',47),
  ('DEF_ROTINA -> ROTINA DEF_ROTINA','DEF_ROTINA',2,'p_def_rotina','sintatic.py',55),
  ('DEF_ROTINA -> <empty>','DEF_ROTINA',0,'p_def_rotina','sintatic.py',56),
  ('CONSTANTE -> CONST ID = CONST_VALOR ;','CONSTANTE',5,'p_constante','sintatic.py',64),
  ('CONST_VALOR -> PALAVRA','CONST_VALOR',1,'p_const_valor','sintatic.py',68),
  ('CONST_VALOR -> EXP_CONST','CONST_VALOR',1,'p_const_valor','sintatic.py',69),
  ('TIPO -> TYPE ID = TIPO_DADO ;','TIPO',5,'p_tipo','sintatic.py',73),
  ('VARIAVEL -> VAR CAMPO ;','VARIAVEL',3,'p_variavel','sintatic.py',77),
  ('LISTA_ID -> , ID LISTA_ID','LISTA_ID',3,'p_lista_id','sintatic.py',81),
  ('LISTA_ID -> <empty>','LISTA_ID',0,'p_lista_id','sintatic.py',82),
  ('CAMPOS -> CAMPO LISTA_CAMPOS','CAMPOS',2,'p_campos','sintatic.py',89),
  ('CAMPO -> ID LISTA_ID : TIPO_DADO','CAMPO',4,'p_campo','sintatic.py',94),
  ('LISTA_CAMPOS -> ; CAMPO LISTA_CAMPOS','LISTA_CAMPOS',3,'p_lista_campos','sintatic.py',98),
  ('LISTA_CAMPOS -> <empty>','LISTA_CAMPOS',0,'p_lista_campos','sintatic.py',99),
  ('TIPO_DADO -> INTEGER','TIPO_DADO',1,'p_tipo_dado','sintatic.py',107),
  ('TIPO_DADO -> REAL','TIPO_DADO',1,'p_tipo_dado','sintatic.py',108),
  ('TIPO_DADO -> CHAR','TIPO_DADO',1,'p_tipo_dado','sintatic.py',109),
  ('TIPO_DADO -> BOOLEAN','TIPO_DADO',1,'p_tipo_dado','sintatic.py',110),
  ('TIPO_DADO -> ARRAY [ NUMERO ] OF TIPO_DADO','TIPO_DADO',6,'p_tipo_dado','sintatic.py',111),
  ('TIPO_DADO -> RECORD CAMPOS END','TIPO_DADO',3,'p_tipo_dado','sintatic.py',112),
  ('TIPO_DADO -> ID','TIPO_DADO',1,'p_tipo_dado','sintatic.py',113),
  ('ROTINA -> FUNCTION ID PARAM_ROTINA : TIPO_DADO BLOCO_ROTINA','ROTINA',6,'p_rotina','sintatic.py',124),
  ('ROTINA -> PROCEDURE ID PARAM_ROTINA BLOCO_ROTINA','ROTINA',4,'p_rotina','sintatic.py',125),
  ('PARAM_ROTINA -> ( CAMPOS )','PARAM_ROTINA',3,'p_param_rotina','sintatic.py',132),
  ('PARAM_ROTINA -> <empty>','PARAM_ROTINA',0,'p_param_rotina','sintatic.py',133),
  ('BLOCO_ROTINA -> DEF_VAR BLOCO','BLOCO_ROTINA',2,'p_bloco_rotina','sintatic.py',140),
  ('LISTA_COM -> ; COMANDO LISTA_COM','LISTA_COM',3,'p_lista_com','sintatic.py',144),
  ('LISTA_COM -> <empty>','LISTA_COM',0,'p_lista_com','sintatic.py',145),
  ('BLOCO_COM -> BLOCO','BLOCO_COM',1,'p_bloco_com','sintatic.py',152),
  ('BLOCO_COM -> COMANDO','BLOCO_COM',1,'p_bloco_com','sintatic.py',153),
  ('COMANDO -> ID NOME ATRIBUICAO','COMANDO',3,'p_comando','sintatic.py',156),
  ('COMANDO -> WHILE EXP_COM DO BLOCO_COM','COMANDO',4,'p_comando','sintatic.py',157),
  ('COMANDO -> IF EXP_COM THEN BLOCO_COM ALTERNATIVA_ELSE','COMANDO',5,'p_comando','sintatic.py',158),
  ('COMANDO -> FOR FOR_COMANDO DO BLOCO_COM','COMANDO',4,'p_comando','sintatic.py',159),
  ('COMANDO -> WRITE CONST_VALOR','COMANDO',2,'p_comando','sintatic.py',160),
  ('COMANDO -> READ ID NOME','COMANDO',3,'p_comando','sintatic.py',161),
  ('FOR_COMANDO -> ID ATRIBUICAO PARAMETRO TO PARAMETRO','FOR_COMANDO',5,'p_for_comando','sintatic.py',177),
  ('ALTERNATIVA_ELSE -> ELSE BLOCO_COM','ALTERNATIVA_ELSE',2,'p_alternativa_else','sintatic.py',181),
  ('ALTERNATIVA_ELSE -> <empty>','ALTERNATIVA_ELSE',0,'p_alternativa_else','sintatic.py',182),
  ('ATRIBUICAO -> ATRIBUICAO_SIMBOLO EXP','ATRIBUICAO',2,'p_atribuicao','sintatic.py',189),
  ('LISTA_PARAM -> PARAMETRO , LISTA_PARAM','LISTA_PARAM',3,'p_lista_param','sintatic.py',193),
  ('LISTA_PARAM -> PARAMETRO','LISTA_PARAM',1,'p_lista_param','sintatic.py',194),
  ('LISTA_PARAM -> <empty>','LISTA_PARAM',0,'p_lista_param','sintatic.py',195),
  ('EXP -> PARAMETRO EXP_L1','EXP',2,'p_exp','sintatic.py',204),
  ('EXP -> ( PARAMETRO EXP_L2','EXP',3,'p_exp','sintatic.py',205),
  ('EXP_L1 -> OP_MAT EXP','EXP_L1',2,'p_exp_l1','sintatic.py',214),
  ('EXP_L1 -> PARAM_LOGICO EXP_LOGICA','EXP_L1',2,'p_exp_l1','sintatic.py',215),
  ('EXP_L1 -> <empty>','EXP_L1',0,'p_exp_l1','sintatic.py',216),
  ('EXP_LOGICA -> OP_LOGICO EXP','EXP_LOGICA',2,'p_exp_logica','sintatic.py',227),
  ('EXP_LOGICA -> <empty>','EXP_LOGICA',0,'p_exp_logica','sintatic.py',228),
  ('PARAM_LOGICO -> OP_COMP PARAMETRO','PARAM_LOGICO',2,'p_param_logico','sintatic.py',236),
  ('PARAM_LOGICO -> <empty>','PARAM_LOGICO',0,'p_param_logico','sintatic.py',237),
  ('EXP_L2 -> OP_MAT EXP )','EXP_L2',3,'p_exp_l2','sintatic.py',245),
  ('EXP_L2 -> PARAM_LOGICO OP_LOGICO EXP )','EXP_L2',4,'p_exp_l2','sintatic.py',246),
  ('EXP_CONST -> PARAMETRO EXP_CONST_L','EXP_CONST',2,'p_exp_const','sintatic.py',254),
  ('EXP_CONST -> ( PARAMETRO OP_MAT EXP_CONST )','EXP_CONST',5,'p_exp_const','sintatic.py',255),
  ('EXP_CONST_L -> OP_MAT EXP_CONST','EXP_CONST_L',2,'p_exp_const_l','sintatic.py',262),
  ('EXP_CONST_L -> <empty>','EXP_CONST_L',0,'p_exp_const_l','sintatic.py',263),
  ('EXP_COM -> PARAMETRO PARAM_LOGICO EXP_COM_L','EXP_COM',3,'p_exp_com','sintatic.py',270),
  ('EXP_COM -> ( PARAMETRO PARAM_LOGICO OP_LOGICO EXP_COM )','EXP_COM',6,'p_exp_com','sintatic.py',271),
  ('EXP_COM_L -> OP_LOGICO EXP_COM','EXP_COM_L',2,'p_exp_com_l','sintatic.py',278),
  ('EXP_COM_L -> <empty>','EXP_COM_L',0,'p_exp_com_l','sintatic.py',279),
  ('PARAMETRO -> ID NOME','PARAMETRO',2,'p_parametro','sintatic.py',286),
  ('PARAMETRO -> NUMERO','PARAMETRO',1,'p_parametro','sintatic.py',287),
  ('PARAMETRO -> FALSE','PARAMETRO',1,'p_parametro','sintatic.py',288),
  ('PARAMETRO -> TRUE','PARAMETRO',1,'p_parametro','sintatic.py',289),
  ('OP_LOGICO -> AND','OP_LOGICO',1,'p_op_logico','sintatic.py',297),
  ('OP_LOGICO -> OR','OP_LOGICO',1,'p_op_logico','sintatic.py',298),
  ('OP_COMP -> >','OP_COMP',1,'p_op_comp','sintatic.py',302),
  ('OP_COMP -> <','OP_COMP',1,'p_op_comp','sintatic.py',303),
  ('OP_COMP -> COMPARACAO','OP_COMP',1,'p_op_comp','sintatic.py',304),
  ('OP_MAT -> +','OP_MAT',1,'p_op_mat','sintatic.py',308),
  ('OP_MAT -> -','OP_MAT',1,'p_op_mat','sintatic.py',309),
  ('OP_MAT -> *','OP_MAT',1,'p_op_mat','sintatic.py',310),
  ('OP_MAT -> /','OP_MAT',1,'p_op_mat','sintatic.py',311),
  ('NOME -> . ID NOME','NOME',3,'p_nome','sintatic.py',315),
  ('NOME -> [ PARAMETRO ]','NOME',3,'p_nome','sintatic.py',316),
  ('NOME -> ( LISTA_PARAM )','NOME',3,'p_nome','sintatic.py',317),
  ('NOME -> <empty>','NOME',0,'p_nome','sintatic.py',318),
]
