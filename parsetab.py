...
_lr_productions = [
  ...
  ('PROGRAMA -> DECLARACOES BLOCO','PROGRAMA',2,'p_programa','analisador_sintatico.py',7),
  ('BLOCO -> BEGIN COMANDO LISTA_COM END','BLOCO',4,'p_bloco','analisador_sintatico.py',11),
  ('DECLARACOES -> DEF_CONST DEF_TIPOS DEF_VAR DEF_ROTINA','DECLARACOES',4,'p_declaracoes','analisador_sintatico.py',15),
  ('DEF_CONST -> CONSTANTE DEF_CONST','DEF_CONST',2,'p_def_const','analisador_sintatico.py',19),
  ('DEF_CONST -> <empty>','DEF_CONST',0,'p_def_const','analisador_sintatico.py',20),
  ('DEF_TIPOS -> TIPO DEF_TIPOS','DEF_TIPOS',2,'p_def_tipos','analisador_sintatico.py',28),
  ('DEF_TIPOS -> <empty>','DEF_TIPOS',0,'p_def_tipos','analisador_sintatico.py',29),
  ('DEF_VAR -> VARIAVEL DEF_VAR','DEF_VAR',2,'p_def_var','analisador_sintatico.py',37),
  ('DEF_VAR -> <empty>','DEF_VAR',0,'p_def_var','analisador_sintatico.py',38),
  ('DEF_ROTINA -> ROTINA DEF_ROTINA','DEF_ROTINA',2,'p_def_rotina','analisador_sintatico.py',46),
  ('DEF_ROTINA -> <empty>','DEF_ROTINA',0,'p_def_rotina','analisador_sintatico.py',47),
  ('CONSTANTE -> CONST ID = CONST_VALOR ;','CONSTANTE',5,'p_constante','analisador_sintatico.py',55),
  ('CONST_VALOR -> PALAVRA','CONST_VALOR',1,'p_const_valor','analisador_sintatico.py',59),
  ('CONST_VALOR -> EXP_CONST','CONST_VALOR',1,'p_const_valor','analisador_sintatico.py',60),
  ('TIPO -> TYPE ID = TIPO_DADO ;','TIPO',5,'p_tipo','analisador_sintatico.py',64),
  ('VARIAVEL -> VAR CAMPO ;','VARIAVEL',3,'p_variavel','analisador_sintatico.py',68),
  ('LISTA_ID -> , ID LISTA_ID','LISTA_ID',3,'p_lista_id','analisador_sintatico.py',72),
  ('LISTA_ID -> <empty>','LISTA_ID',0,'p_lista_id','analisador_sintatico.py',73),
  ('CAMPOS -> CAMPO LISTA_CAMPOS','CAMPOS',2,'p_campos','analisador_sintatico.py',80),
  ('CAMPO -> ID LISTA_ID : TIPO_DADO','CAMPO',4,'p_campo','analisador_sintatico.py',85),
  ('LISTA_CAMPOS -> ; CAMPO LISTA_CAMPOS','LISTA_CAMPOS',3,'p_lista_campos','analisador_sintatico.py',89),
  ('LISTA_CAMPOS -> <empty>','LISTA_CAMPOS',0,'p_lista_campos','analisador_sintatico.py',90),
  ('TIPO_DADO -> INTEGER','TIPO_DADO',1,'p_tipo_dado','analisador_sintatico.py',98),
  ('TIPO_DADO -> REAL','TIPO_DADO',1,'p_tipo_dado','analisador_sintatico.py',99),
  ('TIPO_DADO -> CHAR','TIPO_DADO',1,'p_tipo_dado','analisador_sintatico.py',100),
  ('TIPO_DADO -> BOOLEAN','TIPO_DADO',1,'p_tipo_dado','analisador_sintatico.py',101),
  ('TIPO_DADO -> ARRAY [ NUMERO ] OF TIPO_DADO','TIPO_DADO',6,'p_tipo_dado','analisador_sintatico.py',102),
  ('TIPO_DADO -> RECORD CAMPOS END','TIPO_DADO',3,'p_tipo_dado','analisador_sintatico.py',103),
  ('TIPO_DADO -> ID','TIPO_DADO',1,'p_tipo_dado','analisador_sintatico.py',104),
  ('ROTINA -> FUNCTION ID PARAM_ROTINA : TIPO_DADO BLOCO_ROTINA','ROTINA',6,'p_rotina','analisador_sintatico.py',115),
  ('ROTINA -> PROCEDURE ID PARAM_ROTINA BLOCO_ROTINA','ROTINA',4,'p_rotina','analisador_sintatico.py',116),
  ('PARAM_ROTINA -> ( CAMPOS )','PARAM_ROTINA',3,'p_param_rotina','analisador_sintatico.py',123),
  ('PARAM_ROTINA -> <empty>','PARAM_ROTINA',0,'p_param_rotina','analisador_sintatico.py',124),
  ('BLOCO_ROTINA -> DEF_VAR BLOCO','BLOCO_ROTINA',2,'p_bloco_rotina','analisador_sintatico.py',131),
  ('LISTA_COM -> ; COMANDO LISTA_COM','LISTA_COM',3,'p_lista_com','analisador_sintatico.py',135),
  ('LISTA_COM -> <empty>','LISTA_COM',0,'p_lista_com','analisador_sintatico.py',136),
  ('BLOCO_COM -> BLOCO','BLOCO_COM',1,'p_bloco_com','analisador_sintatico.py',143),
  ('BLOCO_COM -> COMANDO','BLOCO_COM',1,'p_bloco_com','analisador_sintatico.py',144),
  ('COMANDO -> ID NOME ATRIBUICAO','COMANDO',3,'p_comando','analisador_sintatico.py',147),
  ('COMANDO -> WHILE EXP_COM DO BLOCO_COM','COMANDO',4,'p_comando','analisador_sintatico.py',148),
  ('COMANDO -> IF EXP_COM THEN BLOCO_COM ALTERNATIVA_ELSE','COMANDO',5,'p_comando','analisador_sintatico.py',149),
  ('COMANDO -> FOR FOR_COMANDO DO BLOCO_COM','COMANDO',4,'p_comando','analisador_sintatico.py',150),
  ('COMANDO -> WRITE CONST_VALOR','COMANDO',2,'p_comando','analisador_sintatico.py',151),
  ('COMANDO -> READ ID NOME','COMANDO',3,'p_comando','analisador_sintatico.py',152),
  ('FOR_COMANDO -> ID ATRIBUICAO PARAMETRO TO PARAMETRO','FOR_COMANDO',5,'p_for_comando','analisador_sintatico.py',168),
  ('ALTERNATIVA_ELSE -> ELSE BLOCO_COM','ALTERNATIVA_ELSE',2,'p_alternativa_else','analisador_sintatico.py',172),
  ('ALTERNATIVA_ELSE -> <empty>','ALTERNATIVA_ELSE',0,'p_alternativa_else','analisador_sintatico.py',173),
  ('ATRIBUICAO -> ATRIBUICAO_SIMBOLO EXP','ATRIBUICAO',2,'p_atribuicao','analisador_sintatico.py',180),
  ('LISTA_PARAM -> PARAMETRO , LISTA_PARAM','LISTA_PARAM',3,'p_lista_param','analisador_sintatico.py',184),
  ('LISTA_PARAM -> PARAMETRO','LISTA_PARAM',1,'p_lista_param','analisador_sintatico.py',185),
  ('LISTA_PARAM -> <empty>','LISTA_PARAM',0,'p_lista_param','analisador_sintatico.py',186),
  ('EXP -> PARAMETRO EXP_L1','EXP',2,'p_exp','analisador_sintatico.py',195),
  ('EXP -> ( PARAMETRO EXP_L2','EXP',3,'p_exp','analisador_sintatico.py',196),
  ('EXP_L1 -> OP_MAT EXP','EXP_L1',2,'p_exp_l1','analisador_sintatico.py',205),
  ('EXP_L1 -> PARAM_LOGICO EXP_LOGICA','EXP_L1',2,'p_exp_l1','analisador_sintatico.py',206),
  ('EXP_L1 -> <empty>','EXP_L1',0,'p_exp_l1','analisador_sintatico.py',207),
  ('EXP_LOGICA -> OP_LOGICO EXP','EXP_LOGICA',2,'p_exp_logica','analisador_sintatico.py',218),
  ('EXP_LOGICA -> <empty>','EXP_LOGICA',0,'p_exp_logica','analisador_sintatico.py',219),
  ('PARAM_LOGICO -> OP_COMP PARAMETRO','PARAM_LOGICO',2,'p_param_logico','analisador_sintatico.py',227),
  ('PARAM_LOGICO -> <empty>','PARAM_LOGICO',0,'p_param_logico','analisador_sintatico.py',228),
  ('EXP_L2 -> OP_MAT EXP )','EXP_L2',3,'p_exp_l2','analisador_sintatico.py',236),
  ('EXP_L2 -> PARAM_LOGICO OP_LOGICO EXP )','EXP_L2',4,'p_exp_l2','analisador_sintatico.py',237),
  ('EXP_CONST -> PARAMETRO EXP_CONST_L','EXP_CONST',2,'p_exp_const','analisador_sintatico.py',245),
  ('EXP_CONST -> ( PARAMETRO OP_MAT EXP_CONST )','EXP_CONST',5,'p_exp_const','analisador_sintatico.py',246),
  ('EXP_CONST_L -> OP_MAT EXP_CONST','EXP_CONST_L',2,'p_exp_const_l','analisador_sintatico.py',253),
  ('EXP_CONST_L -> <empty>','EXP_CONST_L',0,'p_exp_const_l','analisador_sintatico.py',254),
  ('EXP_COM -> PARAMETRO PARAM_LOGICO EXP_COM_L','EXP_COM',3,'p_exp_com','analisador_sintatico.py',261),
  ('EXP_COM -> ( PARAMETRO PARAM_LOGICO OP_LOGICO EXP_COM )','EXP_COM',6,'p_exp_com','analisador_sintatico.py',262),
  ('EXP_COM_L -> OP_LOGICO EXP_COM','EXP_COM_L',2,'p_exp_com_l','analisador_sintatico.py',269),
  ('EXP_COM_L -> <empty>','EXP_COM_L',0,'p_exp_com_l','analisador_sintatico.py',270),
  ('PARAMETRO -> ID NOME','PARAMETRO',2,'p_parametro','analisador_sintatico.py',277),
  ('PARAMETRO -> NUMERO','PARAMETRO',1,'p_parametro','analisador_sintatico.py',278),
  ('PARAMETRO -> FALSE','PARAMETRO',1,'p_parametro','analisador_sintatico.py',279),
  ('PARAMETRO -> TRUE','PARAMETRO',1,'p_parametro','analisador_sintatico.py',280),
  ('OP_LOGICO -> AND','OP_LOGICO',1,'p_op_logico','analisador_sintatico.py',288),
  ('OP_LOGICO -> OR','OP_LOGICO',1,'p_op_logico','analisador_sintatico.py',289),
  ('OP_COMP -> >','OP_COMP',1,'p_op_comp','analisador_sintatico.py',293),
  ('OP_COMP -> <','OP_COMP',1,'p_op_comp','analisador_sintatico.py',294),
  ('OP_COMP -> COMPARACAO','OP_COMP',1,'p_op_comp','analisador_sintatico.py',295),
  ('OP_MAT -> +','OP_MAT',1,'p_op_mat','analisador_sintatico.py',299),
  ('OP_MAT -> -','OP_MAT',1,'p_op_mat','analisador_sintatico.py',300),
  ('OP_MAT -> *','OP_MAT',1,'p_op_mat','analisador_sintatico.py',301),
  ('OP_MAT -> /','OP_MAT',1,'p_op_mat','analisador_sintatico.py',302),
  ('NOME -> . ID NOME','NOME',3,'p_nome','analisador_sintatico.py',306),
  ('NOME -> [ PARAMETRO ]','NOME',3,'p_nome','analisador_sintatico.py',307),
  ('NOME -> ( LISTA_PARAM )','NOME',3,'p_nome','analisador_sintatico.py',308),
  ('NOME -> <empty>','NOME',0,'p_nome','analisador_sintatico.py',309),
]
